<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('History Inventory Asset Management') }}
        </h2>
    </x-slot>
                    ...
                    <table id="inventoryTable" class="w-full table-auto">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200 text-center text-xs">
                                <td class="px-4 py-2">{{ $history->kode_asset }}</td>
                                <td class="px-4 py-2">{{ $history->asset_category }}</td>
                                <td class="px-4 py-2">{{ $history->asset_position_dept }}</td>
                                <td class="px-4 py-2">{{ $history->asset_type }}</td>
